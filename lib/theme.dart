...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xFFCFD8DC), // button color
      onPrimaryContainer: Color(4280425216), // button content color
      ...
      surface: Color(0XFFDAE1E9), // scaffold background color
      onSurface: Color(0XFF37474F), // font color
      ...
      inversePrimary: Color(0XFFDAE1E9), // app bar background color
